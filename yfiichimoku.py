...
class Ichimoku():
    ...
    def plot_candlesticks(self, fig, ax, view_limit=100):
        # plot candlesticks
        candlesticks_df = self.ohcl_df.loc[:, ['Open', 'High', 'Low', 'Close']]
    ...
    def plot_channels(self, fig, ax, view_limit=100):
        # plot candlesticks
        chan_df = self.ohcl_df.loc[:, ['Open','High','Low', 'Close']]
    ...
    def plot_bbands(self, fig, ax, view_limit=100):
        # plot bbands
        bb_df = self.ohcl_df.loc[:, ['Open','High','Low', 'Close']]
    ...
    def plot_stopbands(self, fig, ax, view_limit=100):
        ...
        # Take a 10 day min of the lows as a price proxy. To put a floor on the stop loss
        price_now = bb_df['Low'].rolling(10).min()
    ...
    def plot_long_bbands(self, fig, ax, view_limit=1000):
        # plot bbands
        # Value of times
